...
def connect(database_name="tournament"):
    """Creates database connection and cursor object, throws exception if there is a connection error"""
...
def deleteMatches():
    """Remove all results record such as wins, losses and match id's from the database.
...
def swissPairings():
    ...
    db_connect, cursor = connect()
    query = ("SELECT player_id, name FROM standings ORDER BY total_wins DESC;")
    cursor.execute(query)
